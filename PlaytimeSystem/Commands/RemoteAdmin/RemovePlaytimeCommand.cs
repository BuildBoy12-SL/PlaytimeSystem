// -----------------------------------------------------------------------
// <copyright file="RemovePlaytimeCommand.cs" company="Build">
...
namespace PlaytimeSystem.Commands.RemoteAdmin
{
    ...
    /// <inheritdoc />
    public class RemovePlaytimeCommand : ICommand
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public string Description { get; set; } = "Resets the playtime of a player";

        /// <summary>
        /// Gets or sets the permission required to use this command.
        /// </summary>
        [Description("The permission required to use this command.")]
        public string RequiredPermission { get; set; } = "pt.remove";
        ...
        public string ProvideArgumentsResponse { get; set; } = "Usage: playtime remove <userId> <time in seconds>";
