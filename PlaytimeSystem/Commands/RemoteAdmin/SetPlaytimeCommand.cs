// -----------------------------------------------------------------------
// <copyright file="SetPlaytimeCommand.cs" company="Build">
...
namespace PlaytimeSystem.Commands.RemoteAdmin
{
    ...
    /// <inheritdoc />
    public class SetPlaytimeCommand : ICommand
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public string Description { get; set; } = "Sets the playtime of a player";
        ...
        /// <summary>
        /// Gets or sets the response to send when a player's playtime is set.
        /// </summary>
        [Description("The response to send when a player's playtime is set.")]
        public string SuccessResponse { get; set; } = "Playtime of {0} has been set.";
